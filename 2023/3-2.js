import { getProduct, isNumber, loopThroughDirections } from "../helper.js";
...
.......................369...515..............100...........174..............................633.973........................................`.split('\n');

let ans = 0;
const visited = {};
function getAdjacentNumber(i, j) {
  function getNumber(x, y) {
    let i = x;
    let j = y;
    let j2 = y - 1;
    let num = "";
    while (lines[i][j] && isNumber(lines[i][j])) {
      num += lines[i][j];
      visited[i + ',' + j] = true;
      j++;
    }
    while (lines[i][j2] && isNumber(lines[i][j2])) {
      num = lines[i][j2] + num;
      visited[i + ',' + j2] = true;
      j2--;
    }
...
for (let i = 0; i < lines.length; i++) {
  ...
  for (let j = 0; j < line.length; j++) {
    if (!isNumber(line[j]) && line[j] !== '.') {
      ans += getAdjacentNumber(i, j);
    }
  }
}
console.log(ans)